    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="mt-8">
            <form enctype="multipart/form-data" class="space-y-5 mt-5" method="POST" action="{{ isset($post) ? route("admin.posts.update", $post->id) : route("admin.posts.store") }}">
                ...
                <select name="category_id" class="w-full h-12 border border-gray-800 rounded px-3 @error('category_id') border-red-500 @enderror" placeholder="Категория" value="{{ $post->category_id ?? '' }}" />
