                    ...
                    <table class="min-w-full">
                        ...
                        @foreach($posts as $post)
                            <tr>
                                ...
                                <td class="px-4 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="text-sm leading-5 text-gray-900">{{ $category[$post->category_id] }}</div>
                                </td>

                                <td class="px-4 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                    <a href="{{ route("admin.posts.show", $post->id) }}" class="text-indigo-600 hover:text-indigo-900">Посмотреть</a>
